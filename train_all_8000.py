...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/ocr_table_all_8000.yaml', help='data.yaml path')
    ...
    parser.add_argument('--project', default='runs/all_8000', help='save to project/name')
