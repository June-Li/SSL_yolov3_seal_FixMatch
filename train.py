...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    dataloader, dataset = create_dataloader(detector, train_path, imgsz, batch_size, gs, opt,
    ...
    if rank in [-1, 0]:
        ...
        testloader = create_dataloader(detector, test_path, imgsz_test, total_batch_size, gs, opt,  # testloader
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/ocr_table.yaml', help='data.yaml path')
